...
test("registro, calendario, persistencia, reprogramación y cancelación", async ({ page }) => {
  ...
  await expect(page.locator(".message-modal")).toContainText("Revise los campos");
  ...
  await page.getByRole("button", { name: "Registrarme y continuar" }).click();
  await expect(page.locator(".message-modal")).toContainText("Sesión iniciada correctamente");
  await page.getByRole("button", { name: "Entendido" }).click();
  ...
  await expect(page.locator(".message-modal").getByRole("heading", { name: "Cita agendada" })).toBeVisible();
  await expect(page.locator(".message-modal")).toContainText("Su cita fue agendada correctamente");
  await expect(page.locator(".message-modal")).toContainText("Guarde el código de su cita");
  await page.getByRole("button", { name: "Entendido" }).click();
  const code = await page.locator(".summary-header p").innerText();
  await page.getByRole("button", { name: "Especialidades", exact: true }).click();
  await page.getByRole("button", { name: "Medicina General", exact: true }).click();
  await expect(page.locator(".message-modal")).toContainText("Ya tiene una cita activa de Medicina General");
  await page.getByRole("button", { name: "Entendido" }).click();
  ...
  await expect(page.locator(".message-modal")).toContainText("Asistencia confirmada");
  await page.getByRole("button", { name: "Entendido" }).click();
  ...
  await expect(page.locator(".message-modal")).toContainText("Su cita fue reprogramada");
  await page.getByRole("button", { name: "Entendido" }).click();
  ...
  await expect(page.locator(".message-modal")).toContainText("La cita fue cancelada");
  await page.getByRole("button", { name: "Entendido" }).click();
  ...
  await page.getByRole("button", { name: "Continuar", exact: true }).click();
  await expect(page.locator(".message-modal")).toContainText("incorrectos");
  await page.getByRole("button", { name: "Entendido" }).click();
  await page.getByLabel("Contraseña").fill("PruebaSegura123");
  await page.getByRole("button", { name: "Continuar", exact: true }).click();
  await expect(page.locator(".message-modal")).toContainText("Sesión iniciada correctamente");
  ...
  await expect(page.locator(".appointment-list")).not.toContainText("CANCELADA");
  await page.getByLabel("Filtrar por estado").selectOption("CANCELADA");
